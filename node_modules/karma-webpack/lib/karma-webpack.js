...
function initKarmaWebpack(files, config, karmaEmitter) {
  files.pop();
  // console.log(files);
  // console.log(config.basePath);
  // console.log(path.join(config.basePath, '.karma-cache/commons.bundle.js'));

  const handler = new KarmaWebpack({
    karmaEmitter
  });
  ...
  files.push({ pattern: path.join(config.basePath, '.karma-cache/one.bundle.js'), included: true, served: true, watched: false });
  files.push({ pattern: path.join(config.basePath, '.karma-cache/two.bundle.js'), included: true, served: true, watched: false });
}

initKarmaWebpack.$inject = ['config.files', 'config', 'emitter'];
