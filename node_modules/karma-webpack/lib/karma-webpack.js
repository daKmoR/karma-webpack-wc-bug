...
function initKarmaWebpack(files, config, emitter, preprocess, fileList) {
  ...
  files.unshift({ pattern: path.join(config.basePath, '.karma-cache/commons.js'), included: true, served: true, watched: false });
  files.unshift({ pattern: path.join(config.basePath, '.karma-cache/runtime.js'), included: true, served: true, watched: false });
...
function preprocessorsToWebpackEntries(preprocessors) {
